...
export default function WalletPage() {
  ...
  // Mock wallet data
  const walletAddress = "JAMIE7XYZABCDEFGHIJKLMNOPQRSTUVWXYZ123456789ABC123DEF";
  const walletBalance = "142.75";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <button 
          onClick={() => navigate(-1)}
          className="group flex items-center gap-2 text-gray-300 hover:text-blue-400 mb-6 transition"
        >
        ...
        <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-8 text-white shadow-2xl mb-8 border border-gray-700">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <a 
                href={`https://testnet.explorer.perawallet.app/address/${walletAddress}`}
                target="_blank"
        ...
        <div className="bg-gray-800 rounded-2xl shadow-lg border border-gray-700 overflow-hidden">
          ...
          <div className="divide-y divide-gray-700">
            {transactions.map(tx => (
              <div 
                key={tx.id}
                className="p-6 hover:bg-gradient-to-r hover:from-gray-700/50 hover:to-gray-700/30 transition"
              >
