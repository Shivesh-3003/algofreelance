...
export const APP_SPEC: Arc56Contract = {"name":"AlgoFreelance","structs":{},"methods":[{"name":"hello","args":[{"type":"string","name":"name"}],"returns":{"type":"string"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":0,"bytes":0}},"keys":{"global":{},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[37],"errorMessage":"OnCompletion must be NoOp && can only call when creating"},{"pc":[26],"errorMessage":"OnCompletion must be NoOp && can only call when not creating"},{"pc":[52],"errorMessage":"invalid number of bytes for (len+utf8[])"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"source":{"approval":"","clear":"I3ByYWdtYSB2ZXJzaW9uIDExCiNwcmFnbWEgdHlwZXRyYWNrIGZhbHNlCgovLyBhbGdvcHkuYXJjNC5BUkM0Q29udHJhY3QuY2xlYXJfc3RhdGVfcHJvZ3JhbSgpIC0+IHVpbnQ2NDoKbWFpbjoKICAgIHB1c2hpbnQgMSAvLyAxCiAgICByZXR1cm4K"},"byteCode":{"approval":"CzEbQQAYgAQCvs4RNhoAjgEAAQAxGRQxGBBEQgAIMRkUMRgUEEM2GgFJgQBZgQIISwEVEkRXAgCAB0hlbGxvLCBMUEkVFlcGAkxQgAQVH3x1TFCwgQFD","clear":"C4EBQw=="},"compilerInfo":{"compiler":"puya","compilerVersion":{"major":5,"minor":2,"patch":0}},"events":[],"templateVariables":{}} as unknown as Arc56Contract
...
export type AlgoFreelanceTypes = {
  ...
  methods:
    & Record<'hello(string)string' | 'hello', {
      argsObj: AlgoFreelanceArgs['obj']['hello(string)string']
      argsTuple: AlgoFreelanceArgs['tuple']['hello(string)string']
      returns: AlgoFreelanceReturns['hello(string)string']
    }>
}
...
export abstract class AlgoFreelanceParamsFactory {
   ...
   */
  static hello(params: CallParams<AlgoFreelanceArgs['obj']['hello(string)string'] | AlgoFreelanceArgs['tuple']['hello(string)string']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class AlgoFreelanceClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the AlgoFreelance smart contract using the `hello(string)string` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    hello: (params: CallParams<AlgoFreelanceArgs['obj']['hello(string)string'] | AlgoFreelanceArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(AlgoFreelanceParamsFactory.hello(params))
    },
  ...
  readonly createTransaction = {
     ...
     */
    hello: (params: CallParams<AlgoFreelanceArgs['obj']['hello(string)string'] | AlgoFreelanceArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(AlgoFreelanceParamsFactory.hello(params))
    },
  ...
  readonly send = {
     ...
     */
    hello: async (params: CallParams<AlgoFreelanceArgs['obj']['hello(string)string'] | AlgoFreelanceArgs['tuple']['hello(string)string']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(AlgoFreelanceParamsFactory.hello(params))
      return {...result, return: result.return as unknown as (undefined | AlgoFreelanceReturns['hello(string)string'])}
    },
  ...
  public newGroup(): AlgoFreelanceComposer {
    ...
    return {
      /**
       * Add a hello(string)string method call against the AlgoFreelance contract
       */
      hello(params: CallParams<AlgoFreelanceArgs['obj']['hello(string)string'] | AlgoFreelanceArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
...
export type AlgoFreelanceComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  hello(params?: CallParams<AlgoFreelanceArgs['obj']['hello(string)string'] | AlgoFreelanceArgs['tuple']['hello(string)string']>): AlgoFreelanceComposer<[...TReturns, AlgoFreelanceReturns['hello(string)string'] | undefined]>
