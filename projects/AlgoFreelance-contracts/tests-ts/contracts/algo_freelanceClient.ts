...
export type AlgoFreelanceComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<AlgoFreelanceComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<AlgoFreelanceComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<AlgoFreelanceComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
